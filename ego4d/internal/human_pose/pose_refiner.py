...
class SkeletonFit:
    def __init__(self, global_iter, total_global_iters):
        ...
        self.num_epochs = 10
        self.ftol = 1e-4
        self.optimizer = dict(type='LBFGS', max_iter=20, lr=0.1, line_search_fn='strong_wolfe')
        self.verbose = True
    ...
    def evaluate(self, poses, init_poses, iter_idx, epoch_idx):
        ...
        ##-------------------------------------------------------
        if self.verbose:
            msg = 'global:{}/{} epoch:{}/{}, iter:{}/{}, loss:'.format(self.global_iter, self.total_global_iters, epoch_idx, self.num_epochs, iter_idx, self.num_iter)
