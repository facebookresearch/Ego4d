...
def load_state_dict(module, state_dict, strict=False, logger=None):
    ...
    model_keys = module.state_dict().keys()
    source_model_keys = state_dict.keys()

    ## if keyword "backbone" is in the source_model_keys, then we use prefix "backbone."
    ## to load the state_dict
    prefix = ''
    if any("backbone" in s for s in source_model_keys):
        print(("backbone keyword is in the source_model_keys"))
        prefix='backbone.'
        
    load(module, prefix=prefix)
