...
PRETRAINED='/media/rawalk/disk1/rawalk/vitpose/checkpoints/vitpose-b.pth'

###--------------------------------------------------------------
## add timestamp to output dir
OUTPUT_DIR="$(echo "Outputs/train/center_vitpose_base_coco_256x192/$(date +"%m-%d-%Y_%H:%M:%S")")"
