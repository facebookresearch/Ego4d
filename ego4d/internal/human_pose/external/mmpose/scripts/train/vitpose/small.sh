...
# ###-----------------------------w32 256 x 192---------------------------
CONFIG_FILE='configs/body/2d_kpt_sview_rgb_img/topdown_heatmap/coco/ViTPose_small_coco_256x192.py'
PRETRAINED='/media/rawalk/disk1/rawalk/vitpose/pretrained/small_pretrained.pth'

###--------------------------------------------------------------
## add timestamp to output dir
OUTPUT_DIR="$(echo "Outputs/train/ViTPose_small_coco_256x192/$(date +"%Y%m%d_%H%M%S")")"
